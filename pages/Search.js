            ...
            <section className="section banner-5">
                        ...
                        <div className="mt-65 mb-100">
                            <div className="row align-items-end">
                                <div className="col-lg-6 mb-20">
                                    <span className="title-line color-black-text">SEARCH AND PERSONALISATION</span>
                    ...
                    <div className="container">
                        <div className="row mt-50 align-items-center card-no-border">
                            <div className="col-lg-6 mb-30">
                                <h2 className="color-brand-1">Personalization Beyond the Algorithm</h2>
                                <div className="title-line mb-10 mt-10 font-md">Personalization is more than recommending “similar items.” It’s about adapting to user behavior, context, and evolving intent. We support personalization efforts through:</div>
                            </div>
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up ">
                                    ...
                                    <div className="card-info mt-15">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="What makes us different from others? We give holistic solutions with strategy, design & technology.">Contextual Understanding</Link></h4>
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info mt-15">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="No lag time, no lost effort when priorities change, no email black hole. As team collaboration improves">Preference Modeling</Link></h4>
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info mt-15">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="Share updates instantly within our project management software, and get the entire team collaborating">Behavioral Data Annotation</Link></h4>
                        ...
                        <div className="box-business-rd">
                            <div className="row align-items-center">
                                <div className="col-lg-5">
                                    <h3 className="color-brand-1 mt-10 mb-15">Why Search Relevance Matters</h3>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <h2 className="color-brand-1 mb-20">Our Process-Oriented Approach</h2>
                                            ...
                                            <td>
                                                <div className="item-forum">
                                                    ...
                                                    <div className="item-info">
                                                        <h4 className="color-brand-1 mb-15">Data Curation & Enrichment</h4>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="item-forum">
                                                    ...
                                                    <div className="item-info">
                                                        <h4 className="color-brand-1 mb-15">Scalable Human-in-the-Loop (HITL)</h4>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="item-forum">
                                                    ...
                                                    <div className="item-info">
                                                        <h4 className="color-brand-1 mb-15">Quality Assurance Frameworks</h4>
                                        ...
                                        <tr>
                                            <td>
                                                <div className="item-forum">
                                                    ...
                                                    <div className="item-info">
                                                        <h4 className="color-brand-1 mb-15">Global & Multilingual Coverage</h4>
                ...
                <section className="section mt-100">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 text-center">
                                <h2 className="color-brand-1 mb-20">The Business Impact</h2>
                            </div>
                        </div>
                        <div className="row mt-50">
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="Seamless importing and round-tripping of Microsoft Project plans, Excel files & CSV files.">Higher User Engagement</Link></h4>
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="What makes us different from others? We give holistic solutions with strategy, design & technology.">Increased Conversions</Link></h4>
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="No lag time, no lost effort when priorities change, no email black hole. As team collaboration improves">Reduced Churn</Link></h4>
                            ...
                            <div className="col-lg-6">
                                <div className="card-offer card-we-do hover-up">
                                    ...
                                    <div className="card-info">
                                        <h4 className="color-brand-1 mb-10"><Link className="color-brand-1" href="Share updates instantly within our project management software, and get the entire team collaborating">Scalable Efficiency</Link></h4>
